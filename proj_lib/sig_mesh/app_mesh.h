...
extern u16 friend_poll; //RD_EDIT them o day
...
#define FRI_POLL_INTERVAL_MS        (friend_poll)	// auto send poll interval
...
#define LPN_SCAN_PROVISION_START_TIMEOUT_MS (provision_time)   // from power up to this time, if didn't receive provision start command, LPN will auto enter sleep.
extern u16 LPN_WorKing_Timeout;
#define LPN_WORKING_TIMEOUT_MS   	        (LPN_WorKing_Timeout)   // Prevent abnormal working time.
